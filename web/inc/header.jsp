<%-- 
    Document   : header
    Created on : Sep 23, 2024, 9:31:28 PM
    Author     : tranq
--%>
...
<html>
  ...
  <link href="https://cdnjs.cloudflare.com/ajax/libs/tailwindcss/2.2.19/tailwind.min.css" rel="stylesheet">
    ...
    <body>
      ...
      <div class=" flex flex-wrap items-center justify-between mx-100 pr-10 pl-10">
        <a href="index.html" class="flex items-center space-x-3 rtl:space-x-reverse">
          <img src="/img/img_logo.png" class="h-10 w-90" alt="Logo" />
        ...
        <div class="flex items-center md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
          <button type="button"
            ...
            <img class="w-8 h-8 rounded-full" src="/img/img_acount.jpg" alt="user photo">
          </button>
          <!-- Dropdown menu -->
          <div
        ...
        <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-user">
          <ul
            ...
            <li>
              <button id="aboutDropdown" data-dropdown-toggle="aboutMenu"
                ...
                About
                <!-- Mũi tên xuống (được căn phải với khoảng cách ml-2) -->
              ...
              <div id="aboutMenu"
                ...
                <ul class="py-1 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="aboutDropdown">
                  <li>
                    <a href="#"
                  ...
                  <li>
                    <a href="#"
                      class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Careers</a>
                  </li>
                  <li>
                    <a href="#"
